...
${OBJECTDIR}/_ext/d735dd4/cpp_utils.o: /home/maxwell/NetBeansProjects/CPP-Utils/source/cpp_utils.cpp nbproject/Makefile-${CND_CONF}.mk
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d735dd4/cpp_utils.o /home/maxwell/NetBeansProjects/CPP-Utils/source/cpp_utils.cpp
...
${OBJECTDIR}/_ext/d735dd4/game_utils.o: /home/maxwell/NetBeansProjects/CPP-Utils/source/game_utils.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/_ext/d735dd4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d735dd4/game_utils.o /home/maxwell/NetBeansProjects/CPP-Utils/source/game_utils.cpp

${OBJECTDIR}/source/automaton.o: source/automaton.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/automaton.o source/automaton.cpp

${OBJECTDIR}/source/terminal_menu.o: source/terminal_menu.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/terminal_menu.o source/terminal_menu.cpp

${OBJECTDIR}/source/terminal_utils.o: source/terminal_utils.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/terminal_utils.o source/terminal_utils.cpp
